...
def test_moment_olko_phd_thesis_fig3p3(spectrum_data_fig3p3_olko_phd: SpectrumData):
    result = first_moment(spectrum_data_fig3p3_olko_phd.bin_edges, spectrum_data_fig3p3_olko_phd.bin_values_freq)
    expected_result = 2
    assert result == pytest.approx(expected_result)
    # check normalized spectrum as well
    result_from_normalized = first_moment(spectrum_data_fig3p3_olko_phd.bin_edges, spectrum_data_fig3p3_olko_phd.bin_values_freq_normalized)
